...
func enrichRDSInstanceWrapper(cfg plugin.EnricherConfig, r *output.CloudResource) error {
...
func EnrichRDSInstance(cfg plugin.EnricherConfig, r *output.CloudResource) error {
