...
func TestRiskFromScanResult_ImpactedResourceID_IncludesFindingID(t *testing.T) {
	...
	assert.Equal(t, "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg/providers/Microsoft.Web/sites/myapp:abc123de", risk.TargetName)
...
func TestRiskFromScanResult_ImpactedResourceID_NoFindingID(t *testing.T) {
	...
	risk := items[0].(capmodel.Risk)
	assert.Equal(t, "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg/providers/Microsoft.Compute/virtualMachines/myvm", risk.TargetName, "should use bare ResourceRef when FindingID is empty")
}
