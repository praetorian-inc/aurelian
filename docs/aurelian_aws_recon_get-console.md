...
```
  ...
  -d, --duration int                   Session duration in seconds (900-3600) (default 3600)
      --federation-name string         Name for federation token (default "aurelian-federation")
  ...
  -R, --role-arn string                AWS Role ARN to assume for console access
      --role-session-name string       Name for the assumed role session (default "aurelian-console-session")
