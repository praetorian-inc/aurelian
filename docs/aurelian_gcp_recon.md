...
* [aurelian gcp recon terraform-state](aurelian_gcp_recon_terraform-state.md)	 - Detect GCS buckets containing Terraform state files and validate their security posture. Checks for public access, versioning, and encryption configuration.
