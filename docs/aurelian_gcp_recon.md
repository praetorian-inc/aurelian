...
* [aurelian gcp recon privesc-detection](aurelian_gcp_recon_privesc-detection.md)	 - Detect GCP privilege escalation paths by testing IAM permissions on projects. Uses testIamPermissions API which does not generate audit logs.
