## aurelian gcp recon artifact-registry-dump

Enumerate Artifact Registry repositories and Docker images across GCP projects.

```
aurelian gcp recon artifact-registry-dump [flags]
```
...
```
  ...
  -h, --help                    help for artifact-registry-dump
