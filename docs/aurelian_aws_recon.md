...
* [aurelian aws recon eip-dangling-takeover](aurelian_aws_recon_eip-dangling-takeover.md)	 - Detects Route53 A records pointing to AWS IP addresses that are not allocated as Elastic IPs in this account. Such dangling records can be taken over by an attacker who allocates the released IP.
