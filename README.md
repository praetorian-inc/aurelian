...
|----------|-------|---------|--------------|
| **Amazon Web Services (AWS)** | `aws`, `amazon` | 13 | Secrets, public resources, IAM graph, subdomain takeover, OPSEC whoami, cost analysis, CDK/CloudFront takeover, enabled-region discovery |
